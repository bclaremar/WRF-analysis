...
LFC, LEQ, TEQ, LFC2, LEQ2 = convpar.convpar(EPTU[0],EPTSU,zU,zp2,TU)
...
# Create a figure
fig = plt.figure(0,figsize=(5,5)) #,figsize=(6,6))
ax=fig.add_subplot(1,1,1)
p=plt.plot(TU, zU,color='red')
p2=plt.plot(TdU, zU)
plt.plot(EPTU, zU,color='pink')
plt.plot(EPTSU, zU,color='green')
plt.plot([-70,70], [LFC,LFC],linestyle='dashed',color='blue',label='LFC')
plt.plot([-70,70], [LEQ,LEQ],linestyle='dashed',color='red',label='LEQ') 
plt.legend(loc='best')
...
if do==1:
  ...
  plt.savefig('sond_2.png', dpi=100, bbox_inches='tight')


# Create a figure
fig = plt.figure(1,figsize=(5,5)) #,figsize=(6,6))
ax=fig.add_subplot(1,1,1)
...
plt.plot([-70,70], [LFC2,LFC2],linestyle='dashed',color='blue',label='LFC')
plt.plot([-70,70], [LEQ2,LEQ2],linestyle='dashed',color='red',label='LEQ') 
plt.legend(loc='best')
plt.plot(Ta, zasq,linestyle='dashed',color='black')
if np.isnan(TEQ)==0:
  plt.text(0.25, 0.95, 'TEQ = ' + str(int(np.sign(TEQ)*(np.abs(TEQ)+0.5))) + ' °C', transform=ax.transAxes, fontsize=14,verticalalignment='top')
...
if do==1:
  ...
  plt.savefig('sond2_2.png', dpi=100, bbox_inches='tight')
...
if do==1:
  ...
  plt.savefig('cross_2.png', dpi=100, bbox_inches='tight')
...
if do==1:
  ...
  plt.savefig('hodo_2.png', dpi=100, bbox_inches='tight')
